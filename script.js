...
'<p>Если вы положите на стол карту, которая не имеет отношения к делу, то в конце игры потеряете 1 очко. Будьте осторожны!<br>Некоторые подсказки совершенно необходимы для раскрытия преступления.</p>' +
...
'<p>Когда все подсказки открыты или отправлены в сброс, игроки обсуждают имеющиеся у них сведения и все вместе выстраивают версию случившегося.<br>На этом этапе вы можете без ограничений обсуждать информацию со сброшенных карт, если вы её запомнили.</p>' +
'<h3>Проверка</h3>' +
'<p>Определившись с версией случившегося, перейдите к ответам на вопросы.<br>После того, как вы ответили на все вопросы, прочтите, что произошло на самом деле.<br>Проверьте свои ответы с подсчетом очков. Каждый правильный ответ приносит 2 очка. Каждая открытая подсказка, не имеющая отношения к делу, лишает вас 1 очка.</p>' +
...
'<p><b>Поезд "Серебряный Ключ", направление - Даскфолл-Локлиф.</b><br><b>18.04.1012 г., 15:55, туннель "Чёрная Пасть".</b></p>' +
