...
const testQuestions = [
    {
        question: "Вопрос 1: Кто убил профессора Восса?",
        options: {a: "Мастер Финн", b: "Леди Ирма Вэйн", c: "Эдвин Торн", d: "Профессор Восс"},
        correct: "d"
    },
    {
        question: "Вопрос 2: Что стало причиной смерти Восса?",
        options: {a: "Яд", b: "Удушение", c: "Удар тяжелым предметом", d: "Магия"},
        correct: "d"
    },
    {
        question: "Вопрос 3: Где сейчас находится оружие убийства?",
        options: {a: "В кармане убийцы", b: "В багаже Восса", c: "В купе номер 3", d: "В купе номер 7"},
        correct: "c"
    },
    {
        question: "Вопрос 4: Какова была мотивация убийцы?",
        options: {a: "Он не хотел отдавать долг", b: "Он был в отчаянии", c: "Ему разбили сердце", d: "Восс его оскорбил"},
        correct: "b"
    },
    {
        question: "Вопрос 5: Как убийца попал в купе номер 3?",
        options: {a: "Через окно", b: "Он всегда был там", c: "Вскрыл дверь отмычкой", d: "Он телепортировался туда"},
        correct: "b"
    },
    {
        question: "Вопрос 6: Кто был таинственным пассажиром из купе номер 7?",
        options: {a: "Безбилетник, который прятался в поезде", b: "Наёмный убийца, который не оставил своего имени", c: "Мастер Финн, который скрывался от кредиторов", d: "Леди Ирма, которая арендовала два купе"},
        correct: "a"
    },
    {
        question: "Вопрос 7: Кто оставил грязные следы в купе Восса?",
        options: {a: "Мастер Финн", b: "Эдвин Торн", c: "Безбилетник", d: "Официант"},
        correct: "c"
    },
    {
        question: "Вопрос 8: Почему Мастер Финн солгал о том, что не открывал дверь купе?",
        options: {a: "Он убил Восса и хотел скрыть это", b: "Он боялся, что его обвинят в убийстве", c: "Ему срочно надо было попасть внутрь, а Восс не открывал", d: "Это его купе"},
        correct: "b"
    },
    {
        question: "Вопрос 9: Кто на самом деле был Поклонником, написавшим записку Воссу?",
        options: {a: "Директор Академии", b: "Мастер Финн", c: "Доктор Арно", d: "Неизвестный Культист"},
        correct: "d"
    },
    {
        question: "Вопрос 10: Почему чай, поданный в 15:15, был холодным в 15:40?",
        options: {a: "На него тоже подействовала магия", b: "Восс открыл окно в туннеле", c: "Восс не любил горячий чай и заморозил его магией", d: "Восс добавил в чай сонное зелье, и он остыл"},
        correct: "a"
    }
];
...
<h3>Ход игры</h3>
<p>Игроки поочередно выкладывают карты - либо в открытую в центр стола, если считают их важными, либо взакрытую в стопку сброса, если информация кажется им несущественной.</p>

<p>В свой ход каждый игрок выполняет одно из следующих действий:</p>

<p><b>А) РАСКРЫВАЕТ ИНФОРМАЦИЮ:</b> Выберите карту из руки и положите её на стол так, чтобы все игроки могли прочитать, что на ней написано. Рекомендуется в этот момент зачитывать вслух всю информацию с карты.</p>

<p>Если вы положите на стол карту, которая не имеет отношения к делу, то в конце игры потеряете 1 очко. Будьте осторожны!<br>
Некоторые подсказки совершенно необходимы для раскрытия преступления.</p>

<p><b>Б) СБРАСЫВАЕТ КАРТУ:</b> Выберите карту с руки и положите её рубашкой вверх в стопку сброса. Вы не можете делиться информацией с этой карты до того, как все остальные карты будут разыграны.</p>

<p><b>ВАЖНО:</b> в конце игры в стопке сброса должно быть не менее 6 карт. Если в конце игры карт в стопке сброса оказалось меньше, вы лишаетесь 3 очков за каждую недостающую карту.</p>

<p>В конце хода возьмите карту, если колода ещё не опустела.</p>

<p>Чтобы раскрыть дело, очень важно обсуждать имеющуюся информацию. Постоянно проверяйте открытые подсказки и перечитывайте, что на них написано.</p>

<p>Вы не можете обсуждать информацию с карт у вас в руке, но можете произносить <u><b>выделенные слова</b></u> и текст в рамочке.</p>

<h3>Построение версии случившегося</h3>
<p>Когда все подсказки открыты или отправлены в сброс, игроки обсуждают имеющиеся у них сведения и все вместе выстраивают версию случившегося.<br>
На этом этапе вы можете без ограничений обсуждать информацию со сброшенных карт, если вы её запомнили.</p>

<h3>Проверка</h3>
<p>Определившись с версией случившегося, перейдите к ответам на вопросы.<br>
После того, как вы ответили на все вопросы, прочтите, что произошло на самом деле.<br>
Проверьте свои ответы с подсчетом очков. Каждый правильный ответ приносит 2 очка. Каждая открытая подсказка, не имеющая отношения к делу, лишает вас 1 очка.</p>

<h3>Правила для одного игрока</h3>
<p>Найдите друзей (без негатива, это очень грустно).</p>
    `);
}

function toggleBackstory() {
    showInfoModal('Предыстория', `
<p><b>Поезд "Серебряный Ключ", направление - Даскфолл-Локлиф.</b><br>
<b>18.04.1012 г., 15:55, туннель "Чёрная Пасть".</b></p>

<p><i>Свет в поезде на секунду мигает. Проводница выходит в коридор, чтобы проверить, что случилось. Она видит, что дверь в купе номер 3 приоткрыта.</i></p>

<p><b>Проводница Грета:</b> "Профессор Восс, вы на месте? Свет только что мигнул, как бы не поломка."</p>

<p><i>Тишина. Грета продолжает.</i></p>

<p><b>Проводница Грета:</b> "Профессор Восс, пассажирам стоит оставаться на месте, мы не сможем вас высадить в случае аварийной остановки."</p>

<p><i>Тишина. Грета заходит в купе.</i></p>

<p><i>Внутри, в кресле, сидит мужчина. Его глаза закрыты, лицо бледно-серое, а кожа на руках выглядит сморщенной, как у столетнего старика. Он не дышит.</i></p>

<p><i>Это профессор Альберт Восс, профессор, ведущий предмет артефакторики в академии Локлиф. Он мёртв.</i></p>

<p><i>Проводница кричит и зовёт на помощь. Пассажиры выходят в коридор.</i></p>
    `);
}
