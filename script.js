...
<h3>Ход игры</h3>
Игроки поочередно выкладывают карты - либо в открытую в центр стола, если считают их важными, либо взакрытую в стопку сброса, если информация кажется им несущественной.
<br>
В свой ход каждый игрок выполняет одно из следующих действий:<br>
А) РАСКРЫВАЕТ ИНФОРМАЦИЮ: Выберите карту из руки и положите её на стол так, чтобы все игроки могли прочитать, что на ней написано. Рекомендуется в этот момент зачитывать вслух всю информацию с карты.
<br>
Если вы положите на стол карту, которая не имеет отношения к делу, то в конце игры потеряете 1 очко. Будьте осторожны!<br>
Некоторые подсказки совершенно необходимы для раскрытия преступления.<br>
<br>
Б) СБРАСЫВАЕТ КАРТУ: Выберите карту с руки и положите её рубашкой вверх в стопку сброса. Вы не можете делиться информацией с этой карты до того, как все остальные карты будут разыграны.
<br>
ВАЖНО: в конце игры в стопке сброса должно быть не менее 6 карт. Если в конце игры карт в стопке сброса оказалось меньше, вы лишаетесь 3 очков за каждую недостающую карту.
<br>
В конце хода возьмите карту, если колода ещё не опустела.
<br>
Чтобы раскрыть дело, очень важно обсуждать имеющуюся информацию. Постоянно проверяйте открытые подсказки и перечитывайте, что на них написано.
<br>
Вы не можете обсуждать информацию с карт у вас в руке, но можете произносить <u><b>выделенные слова</b></u> и текст в рамочке.
<br>
<h3>Построение версии случившегося</h3>
Когда все подсказки открыты или отправлены в сброс, игроки обсуждают имеющиеся у них сведения и все вместе выстраивают версию случившегося.
На этом этапе вы можете без ограничений обсуждать информацию со сброшенных карт, если вы её запомнили.
<br>
<h3>Проверка</h3>
Определившись с версией случившегося, перейдите к ответам на вопросы.<br>
После того, как вы ответили на все вопросы, прочтите, что произошло на самом деле.<br>
Проверьте свои ответы с подсчетом очков. Каждый правильный ответ приносит 2 очка. Каждая открытая подсказка, не имеющая отношения к делу, лишает вас 1 очка.<br>
<br>
<h3>Правила для одного игрока</h3>
Найдите друзей (без негатива, это очень грустно).
    `);
}
...
function toggleBackstory() {
    showInfoModal('Предыстория', `
        <h3>Предыстория</h3>
<b>Поезд "Серебрянный Ключ", направление - Даскфолл-Локлиф.</b>  
