...
const testQuestions = [
    ...
    },
    {
        ...
        options: {a: "Безбилетник, который прятался в поезде", b: "Наёмный убийца, который не оставил своего имени", c: "Мастер Финн, который скрывался от кредиторов", d: "Некто Сухат Д."},
        correct: "a"
    },
    {
    ...
    },
    {
        ...
        options: {a: "Сухат Д.", b: "Мастер Финн", c: "Доктор Арно", d: "Неизвестный Культист"},
        correct: "d"
    },
    {
